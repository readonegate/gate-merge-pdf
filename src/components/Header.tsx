      ...
      <div className="container flex items-center justify-between">
        ...
        <nav>
          <ul className="flex items-center gap-6">
            <li className={location.pathname === "/" ? "font-medium text-pdf" : "text-muted-foreground hover:text-foreground transition-colors"}>
              <Link to="/">Merge PDF</Link>
            </li>
            <li className={location.pathname === "/split-pdf" ? "font-medium text-pdf" : "text-muted-foreground hover:text-foreground transition-colors"}>
